...
class GCD:
    ...
    def GCD(a, b):
        """
            ...
            Source: https://math.stackexchange.com/questions/3379695/why-does-the-euclidean-algorithm-for-finding-gcd-work
    ...
    @staticmethod
    def GCDOfList(arr):
        return functools.reduce(lambda a, b: GCD.GCD(a, b), arr)
            
if __name__ == "__main__":
    print(GCD.GCD(18, 27)) # Should be 6.
    print(GCD.GCDOfList([12, 24, 27, 30, 36])) # Should be 6.
